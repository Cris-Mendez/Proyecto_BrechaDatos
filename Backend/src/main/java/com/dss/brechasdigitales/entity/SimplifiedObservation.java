...
public class SimplifiedObservation {
    ...
    public String getUrbanisationLabel() {
        return urbanisationLabel;
    }

    public void setUrbanisationLabel(String urbanisationLabel) {
        this.urbanisationLabel = urbanisationLabel;
    }
