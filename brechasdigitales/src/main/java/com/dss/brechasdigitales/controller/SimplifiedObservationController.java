...
public class SimplifiedObservationController {
    ...
    // Obtiene las observaciones filtradas por nombre de indicador (p. ej. "Internet users").
    ...
    // **Equivalente funcionalmente a getAll()** (también retorna todas las observaciones).
