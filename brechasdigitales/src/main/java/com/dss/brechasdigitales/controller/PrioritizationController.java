...
public class PrioritizationController {
    ...
    @Autowired
    private SimplifiedObservationRepository observationRepository; // ✅ Repositorio para consultar catálogos/distintos valores
    ...
    public List<PrioritizationService.PriorityRegion> getPriorityRegions(
        ...
        // Delegamos en el servicio el cálculo de regiones prioritarias considerando filtros
